...
// 2. displayPrompt bool: if true, then the promt is display an the user is expected to enter a command.
...
function Stage(displayMessage, displayPrompt, imageFilename, promptSolution) {
